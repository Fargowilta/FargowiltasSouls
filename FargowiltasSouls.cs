            ...
            try
            {
                ...
                switch (code)
                {
                    ...
                    case "GiveDevianttGifts":
                        ...
                        Main.npcChatText = FargoSoulsUtil.IsChinese ? "这个世界看起来比通常更加艰难，所以你可以白嫖这些东西，不过只能一次！当你需要任何提示的时候告诉我，好吗？" : "This world looks tougher than usual, so you can have these on the house just this once! Talk to me if you need any tips, yeah?";
                        break;
