		...
		public override void AI()
		{
			...
			if (++Projectile.ai[0] == 50) //spawn axe
			{
				...
				if (Projectile.owner == Main.myPlayer)
				{
					...
					FargoSoulsUtil.NewSummonProjectile(Projectile.GetSource_FromThis(), Projectile.Center + offset, Vector2.Zero, ModContent.ProjectileType<NekomiAxe>(),
			...
			else if (Projectile.ai[0] < 100)
			{
				...
				Vector2 targetPos = Main.player[Projectile.owner].Center + new Vector2(100 * Projectile.direction, -100);
