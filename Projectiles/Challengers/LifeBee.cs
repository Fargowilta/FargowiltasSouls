...
namespace FargowiltasSouls.Projectiles.Challengers
{
    ...
    public class LifeBee : ModProjectile //note: not actually bee
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == 45f)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, shootoffset1, ModContent.ProjectileType<LifeBee2>(), damage, knockBack, Main.myPlayer);
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, shootoffset2, ModContent.ProjectileType<LifeBee2>(), damage, knockBack, Main.myPlayer);
                }
            }
